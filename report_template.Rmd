...
### Diferença entre IMC de Homens e Mulheres
Dada a suposta natureza do IMC das mulheres ser inferior aos homens [ADD REF.], torna-se relevante realizar a mesma análise dentro do universo de estudo. Para isso, podemos testar a alternativa de o imc masculino ($imc_m$) ser maior que o feminino ($imc_f$).
$$\begin{cases} H_0: imc_f = imc_m&\\H_1: imc_f<imc_m\end{cases}$$
